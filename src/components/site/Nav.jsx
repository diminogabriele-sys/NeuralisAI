      ...
      <header className="fixed top-0 left-0 right-0 z-50 py-6 bg-transparent">
        <div className="mx-auto max-w-[1440px] px-6 md:px-12 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-2">
            ...
            <span className="font-display uppercase tracking-[0.083em] text-[13px] text-titanium">Veloce</span>
          </a>
            ...
            >
              ...
              <nav className="flex flex-col gap-6">
                {links.map((l, i) => (
                  ...
                  >
                    {l.to ? (
                      <Link to={l.to} className="font-display uppercase text-[13px] tracking-[0.083em] text-titanium hover:text-brabus transition-colors">
                        {l.label}
                      </Link>
                    ) : (
                      <Link to={{ pathname: "/", hash: l.href }} className="font-display uppercase text-[13px] tracking-[0.083em] text-titanium hover:text-brabus transition-colors">
                        {l.label}
                      </Link>
                    )}
                  </motion.div>
              ...
              <div className="flex flex-col gap-2 font-body text-[10px] uppercase tracking-[0.091em] text-fumo">
                <div className="h-px bg-steel" />
                <div className="flex justify-between">
                  <span>Torino · Su appuntamento</span>
                  <span>NeuralisAI@outlook.it</span>
                </div>
              </div>
            </motion.div>
          </>
